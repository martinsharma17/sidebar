...
export function SidebarItem({ icon, text, active, alert }) {
    ...
    return (
        ...
        <li className={` relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group ${active ? "bg-gradient-to-tr bg-green-400 to-indigo-100 text-black-800" : "hover:bg-green-400  text-black-600"}`}>
            {icon}
